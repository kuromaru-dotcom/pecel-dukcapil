...
export default function Analytics() {
  ...
  // Redirect if not Super Admin - using useEffect to prevent re-render issues
  useEffect(() => {
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-auto min-w-[280px] h-10 rounded-xl border-warm-200 justify-start text-left font-normal"
