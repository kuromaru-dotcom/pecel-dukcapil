...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // POST /api/documents - Create new document (CS and above)
  app.post("/api/documents", requireAuth, requireRole('cs', 'operator', 'superadmin'), validateBody(createDocumentSchema), asyncHandler(async (req: any, res: any) => {
